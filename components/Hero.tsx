    ...
    <section className={`relative min-h-screen flex flex-col justify-center px-6 pt-28 pb-20 overflow-hidden transition-colors duration-500 ${isDarkMode ? 'bg-[#0A0D14]' : 'bg-[#FDFDFD]'}`}>
      ...
      <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
        <div className="lg:col-span-6 z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
            ...
            <a
              ...
              className={`px-10 py-5 border text-[11px] font-bold uppercase tracking-[0.2em] text-center transition-all flex items-center justify-center gap-3 group ${isDarkMode
        ...
        <div className="lg:col-span-6 relative flex justify-center lg:justify-end">
          <div className={`relative z-10 border p-2 transition-colors duration-500 group ${isDarkMode ? 'border-white/5 bg-white/[0.02]' : 'border-black/5 bg-black/[0.01] shadow-2xl'
            ...
            <div className="overflow-hidden aspect-[9/16] relative bg-slate-900">
              ...
              <img
                src="/images/escritorio-pedrosa.jpg"
            ...
            <div className={`absolute -bottom-6 -left-6 md:-left-12 p-6 md:p-8 border-l-4 border-[#EFA335] shadow-2xl z-20 max-w-[240px] md:max-w-[300px] animate-fade-in glass ${isDarkMode ? 'text-white/80' : 'bg-white/95 text-slate-700 border-y border-r border-black/5'
              }`}>
              <div className="mb-4">
